...
class PyTorchImporter(RelayImporter):
    ...
    def _register_ops():
        ...
        def infer_correct_layout(attrs, new_in_layouts, old_in_layouts, old_in_types):
            ...
            if new_in_layouts is not None:
                rank_to_channel_first_layout = {
                    3: [[channel_first_data_layout_3d, channel_first_data_layout_3d, channel_first_data_layout_3d], [new_in_layouts[0]]],
                    4: [[channel_first_data_layout_4d, channel_first_data_layout_4d, channel_first_data_layout_4d], [new_in_layouts[0]]],
                    5: [[channel_first_data_layout_5d, channel_first_data_layout_5d, channel_first_data_layout_5d], [new_in_layouts[0]]],
                }
                rank_to_spatial_first_layout = {
                    3: [[spatial_first_data_layout_3d, spatial_first_data_layout_3d, spatial_first_data_layout_3d], [new_in_layouts[0]]],
                    4: [[spatial_first_data_layout_4d, spatial_first_data_layout_4d, spatial_first_data_layout_4d], [new_in_layouts[0]]],
                    5: [[spatial_first_data_layout_5d, spatial_first_data_layout_5d, spatial_first_data_layout_5d], [new_in_layouts[0]]],
                }
            else:
                rank_to_channel_first_layout = {
                    3: [[channel_first_data_layout_3d, channel_first_data_layout_3d, channel_first_data_layout_3d], [old_in_layouts[0]]],
                    4: [[channel_first_data_layout_4d, channel_first_data_layout_4d, channel_first_data_layout_4d], [old_in_layouts[0]]],
                    5: [[channel_first_data_layout_5d, channel_first_data_layout_5d, channel_first_data_layout_5d], [old_in_layouts[0]]],
                }
                rank_to_spatial_first_layout = {
                    3: [[spatial_first_data_layout_3d, spatial_first_data_layout_3d, spatial_first_data_layout_3d], [old_in_layouts[0]]],
                    4: [[spatial_first_data_layout_4d, spatial_first_data_layout_4d, spatial_first_data_layout_4d], [old_in_layouts[0]]],
                    5: [[spatial_first_data_layout_5d, spatial_first_data_layout_5d, spatial_first_data_layout_5d], [old_in_layouts[0]]],
                }
    ...
    def convert_to_relay(self, input_model_path, **kwargs):
        ...
        return self.mod, self.params, output_names_dict, self.expr_to_quantization_params_dict
