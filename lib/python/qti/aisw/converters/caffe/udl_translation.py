...
class UdlTranslation(CaffeTranslationBase):
    ...
    def extract_parameters(self, udl_layer, converter_context):
        ...
        blob_output = udl_func(layer, converter_context.weights, input_shapes)
    ...
    def extract_input_names(self, udl_layer, converter_context):
        layer = udl_layer[0]
        return list(map(str, layer.bottom))

    def extract_output_names(self, udl_layer, converter_context):
        layer = udl_layer[0]
