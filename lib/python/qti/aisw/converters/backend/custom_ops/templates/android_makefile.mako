...
# setup include paths
PACKAGE_C_INCLUDES += -I $(QNN_SDK_ROOT)/include -I $(QNN_SDK_ROOT)/include/${package_info.backend.upper()} -I $(LOCAL_PATH)/../include/ -I $(UTIL_SRC_DIR) -I $(UTIL_SRC_DIR)/${package_info.backend.upper()} -I $(CUSTOM_OP_DIR)
