...
%if DSP_ARCH >= 68:
X86_LIBNATIVE_RELEASE_DIR = $(HEXAGON_SDK_ROOT)/tools/HEXAGON_Tools/8.4.09/Tools
...
AARCH64_CXX_FLAGS = $(AARCH64_C__FLAGS) -I$(QNN_INCLUDE) -I$(QNN_HTP_INCLUDE) -I$(QNN_HTP_INCLUDE)/core -fomit-frame-pointer -Wno-invalid-offsetof  -Wno-unused-variable -Wno-unused-parameter -Wno-missing-braces -Wno-sign-compare -Wno-unused-private-field -Wno-unused-variable -Wno-ignored-qualifiers -Wno-missing-field-initializers
...
AARCH64_LDFLAGS = -L$(SNPE_ROOT)/lib/aarch64-android-clang8.0/ -lSnpeHtpPrepare
