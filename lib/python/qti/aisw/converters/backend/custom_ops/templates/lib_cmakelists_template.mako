...
set( CUSTOM_OP_DIR $ENV{QNN_SDK_ROOT}/target/x86_64-linux-clang/share/OpPackageGenerator/CustomOp )
...
list(APPEND LIB_INCLUDES $ENV{QNN_SDK_ROOT}/include/CPU)
%endif
%endif
