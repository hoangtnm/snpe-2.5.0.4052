...
from qti.aisw.converters.tensorflow.layers.split import SplitLayerResolver
...
class LstmLayerBuilder(LayerBuilder):
    ...
    def _ignore_split_reshape_layers(converter_context, descriptor, input_descriptors):
        ...
        def is_split_or_unpack(in_desc):
            return isinstance(in_desc, (SplitLayerResolver.Descriptor, UnPackLayerResolver.Descriptor))
