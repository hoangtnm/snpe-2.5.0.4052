...
def extractConfigParams(config_path):
    ...
    try:
        ...
        if "CAFFE_BIN" in configInfosJson:
            configParams["caffe_bin"] = configInfosJson["CAFFE_BIN"]
...
def extractEnvironmentConfigParams(config_path):
    ...
    try:
        ...
        if "CAFFE_HOME" in configInfosJson:
            generatorConfigParams["CAFFE_HOME"] = configInfosJson["CAFFE_HOME"]
        if "CAFFE_SSD_HOME" in configInfosJson:
            generatorConfigParams["CAFFE_SSD_HOME"] = configInfosJson["CAFFE_SSD_HOME"]
